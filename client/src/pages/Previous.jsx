...
{
    const semesters = ["FA2025", "SP2026", "FA2026", "SP2027"];
    ...
    async function loadCourses() {
        try {
            ...
            const formatted = data.map((c, index) => {
                ...
                return {
                    id: index,
                    semester: null, // not stored in DB yet
                    credits: c.credit,
    ...
    //if we find data in a search param, we use it, if we dont then we pull data from db
    useEffect(() =>
        {
